...
const Faq = () => {
  ...
  const faqData = [
    ...
    {
      question: "Do you offer redesign existing software",
      answer:
    ...
    {
      question: "What does your development process",
      answer:
  ...
  return (
    <div className="bg-[#101215]">
      <div className="p-5 md:px-20 md:py-[100px] overflow-hidden container-class">
        <div className="flex flex-col justify-between md:flex-row md:items-start gap-5 sm:gap-[60px]">
          ...
          <div className="max-w-[456px] w-full p-3 sm:p-10 bg-[#282E39] rounded-[20px]">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=vordxtechnologies@gmail.com">
