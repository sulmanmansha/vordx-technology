...
const data = [
  {
    ...
    title: "Tribute-chapter",
    para: "Tribute Chapter is a platform where families and friends can create memorials, share stories, photos, and celebrate loved ones together",
    tag: "WEBSITE",
    date: "Travel & Hospitality",
  },
  {
    id: 2,
    src: "/images/frontend2.jpg",
    title: "Cyber Security",
    para: "Cyber Security focuses on protecting systems, networks, and data from digital attacks, ensuring safe and reliable use of technology.",
    tag: "LANDING PAGE",
        ...
        >
          <div className="relative w-full h-full rounded-2xl overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 pointer-events-none">
              <div className="w-full h-full bg-gradient-to-b from-[#c5474705] to-[#000000DB]" />
            </div>
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-6 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out z-20">
              ...
              <div className="flex justify-between mb-4">
                <span className="bg-[#0000007A] px-4 py-2 rounded-full text-[12px] sm:text-[16px] leading-5 text-white">
                  {item.tag}
                </span>
                <span className="bg-[#0000007A] px-4 py-2 rounded-full text-[12px] sm:text-[16px] leading-5 text-white">
                  {item.date}
              ...
              <div>
                ...
                <p className="mt-[10px] text-[16px] md:text-[18px] leading-6 text-white">
                  {item.para}
                </p>
              </div>
            </div>
