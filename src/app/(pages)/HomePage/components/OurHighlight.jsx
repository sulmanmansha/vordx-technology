...
const cardData = {
  ...
  "Events & Meetups": [
    ...
    },
    {
      ...
      imageWidth: 372,
      imageHeight: 212,
      text: "Vordx Hosts Exclusive AI-Powered Solutions...",
      isLarge: false,
    },
    {
      id: 6,
      ...
      imageWidth: 372,
      imageHeight: 212,
      text: "Networking with the Best: A Recap of Last Meetup...",
      isLarge: false,
    },
  ],
  "Inside Vordx": [
              ...
              (item) => (
                <p
                  ...
                  className={`heightlight-heading rounded-l-[100px] cursor-pointer ${
                    activeItem === item
                      ? "bg-gradient-to-r from-[rgba(161,249,25,0.60)] to-[rgba(62,3,179,0.2)]"
                      : ""
                  }`}
